...
import { createInternship, getCurrentEmployerId } from '../../../lib/api/employer';
...
export function CreateInternship() {
  ...
  const { register, handleSubmit, control, watch, formState: { errors }, trigger } = useForm<InternshipForm>({
